...
int main()
{
    ...
    cout << "All rights belong to their respective owners. For classroom use only." << endl
         << endl;
    ...
    cout << "SCENE 1  PROLOGUE" << endl
         << endl;
    cout << "District 67, outskirts of Rukongai." << endl
         << endl;
    ...
    case 3:
        ...
        break;
    default:
        cout << "Invalid option! Hanae was dissapointed. " << endl
             << endl;
    }
    ...
    cout << "You find Riku, a tinkerer surrounded by scraps of strange metal." << endl
         << endl;
    ...
    cout << "You pass a ruined shrine. Sister Midori kneels in prayer." << endl
         << endl;
    ...
    cout << "A shadow in the corner alley beckons you. Yumi, the smuggler, grins." << endl
         << endl;
    ...
    cout << "An old peddler, Kaji, rattles his cart of bottles and charms." << endl
         << endl;
    ...
    cout << "Aiko, a small child, tugs at your sleeve with pleading eyes." << endl
         << endl;
    ...
    cout << "Your old mentor, Renga, leans on his cane and lowers his sunglasses." << endl
         << endl;
    ...
    cout << "Mika holds a tray of strange charms." << endl
         << endl;
    ...
    cout << "You find a hidden cache of supplies — medicine, weapons, armor." << endl
         << endl;
    cout << "Choose:" << endl;
